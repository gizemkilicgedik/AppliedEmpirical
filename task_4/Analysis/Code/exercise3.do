capture log close
cd /Users/gizemkilicgedik/Desktop/AppliedEmpirical/task_4
pwd
log using exercise3.log, replace 

//exercise3.do

//Gizem Kilicgedik Septermber 27, 2023

//This is the do file for Exercise 3(Testing for data generating process) in Task 4. In this exercise, we are using 2002-2011 growth dataset. The goal is to implement the prediction methods that we have learned: subset selection, lasso and ridge regression.
