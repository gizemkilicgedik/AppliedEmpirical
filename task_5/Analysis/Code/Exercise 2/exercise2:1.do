...
//This is the do file for Exercise 2/1(Within-time period prediction) in Task 5. In this exercise, we are using 1992-2002 growth dataset. The goal is to implement the prediction methods that we have learned: subset selection, lasso, ridge regression, and random forests.
